    ...
    <div className="min-h-screen bg-gray-950 text-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden md:block text-xs text-gray-400 bg-gray-800 px-3 py-1 rounded-full border border-gray-700">
              ✨ AI-Generated Demo by Site Formers
            </span>
      ...
      <footer className="border-t border-gray-800 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">Demo generated by <span className="text-purple-400 font-medium">Site Formers</span> AI</p>
          <Link to="/" className="text-purple-400 hover:text-purple-300 text-sm font-medium">
            ← Back to Site Formers
          </Link>
        </div>
      </footer>
    </div>

...
export default function PreviewDemo() {
  ...
  const { heroHeadline, heroSubtext, primaryColor, secondaryColor, theme, services, features, ctaText, tagline, testimonials, testimonial, aboutText, stats, faq, heroImage, portfolio, galleryImages } = pageData;
      ...
      <section className="pt-32 pb-24 px-6 relative overflow-hidden">
        {heroImage && (
          <div className="absolute inset-0 z-0">
            <img src={heroImage} alt="" className="w-full h-full object-cover absolute inset-0" style={{ opacity: isLight ? 0.08 : 0.12 }}
